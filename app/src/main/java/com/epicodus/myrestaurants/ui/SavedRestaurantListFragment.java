...
public class SavedRestaurantListFragment extends Fragment implements OnStartDragListener {
    ...
    private FirebaseRestaurantListAdapter firebaseRestaurantListAdapter;
    ...
    private void setUpFirebaseAdapter() {
        ...
        firebaseRestaurantListAdapter = new FirebaseRestaurantListAdapter(Restaurant.class,
                R.layout.restaurant_list_item_drag, FirebaseRestaurantViewHolder.class,
                query, this, getActivity());

        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(firebaseRestaurantListAdapter);

        firebaseRestaurantListAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            @Override
            public void onItemRangeInserted(int positionStart, int itemCount) {
                super.onItemRangeInserted(positionStart, itemCount);
                firebaseRestaurantListAdapter.notifyDataSetChanged();
            }
        });

        ItemTouchHelper.Callback callback = new SimpleItemTouchHelperCallback(firebaseRestaurantListAdapter);
    ...
    public void onDestroy() {
        super.onDestroy();
        firebaseRestaurantListAdapter.cleanup();
    }
